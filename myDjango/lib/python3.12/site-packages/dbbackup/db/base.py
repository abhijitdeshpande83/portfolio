...
CONNECTOR_MAPPING = {
    ...
    "django.db.backends.Removedql": "dbbackup.db.Removedql.PgDumpBinaryConnector",
    "django.db.backends.Removedql_psycopg2": "dbbackup.db.Removedql.PgDumpBinaryConnector",
    ...
    "django.contrib.gis.db.backends.postgis": "dbbackup.db.Removedql.PgDumpGisConnector",
    ...
    "django_prometheus.db.backends.Removedql": "dbbackup.db.Removedql.PgDumpBinaryConnector",
    ...
    "django_prometheus.db.backends.postgis": "dbbackup.db.Removedql.PgDumpGisConnector",
}
