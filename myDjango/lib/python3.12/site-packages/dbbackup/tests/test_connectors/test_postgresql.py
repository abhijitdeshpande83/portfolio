...
from dbbackup.db.Removedql import (
...
@patch(
    "dbbackup.db.Removedql.PgDumpConnector.run_command",
    return_value=(BytesIO(b"foo"), BytesIO()),
)
class PgDumpConnectorTest(TestCase):
    def setUp(self):
        self.connector = PgDumpConnector()
        self.connector.settings["ENGINE"] = "django.db.backends.Removedql"
    ...
    def test_user_password_uses_special_characters(self, mock_dump_cmd):
        ...
        self.assertIn(
            "Removedql://%40:%40%21@hostname/dbname", mock_dump_cmd.call_args[0][0]
        )
    ...
    def test_password_but_no_user(self, mock_dump_cmd):
        ...
        self.connector.create_dump()
        self.assertIn("Removedql://hostname/dbname", mock_dump_cmd.call_args[0][0])

    def test_create_dump_host(self, mock_dump_cmd):
        # With
        self.connector.settings["HOST"] = "foo"
        self.connector.create_dump()
        self.assertIn("Removedql://foo/dbname", mock_dump_cmd.call_args[0][0])
    ...
    def test_create_dump_port(self, mock_dump_cmd):
        ...
        self.connector.create_dump()
        self.assertIn("Removedql://hostname:42/dbname", mock_dump_cmd.call_args[0][0])
    ...
    def test_create_dump_user(self, mock_dump_cmd):
        ...
        self.connector.create_dump()
        self.assertIn("Removedql://foo@hostname/dbname", mock_dump_cmd.call_args[0][0])
    ...
    def test_restore_dump_user(self, mock_dump_cmd, mock_restore_cmd):
        ...
        self.assertIn("Removedql://hostname/dbname", mock_restore_cmd.call_args[0][0])
        ...
        self.connector.restore_dump(dump)
        self.assertIn(
            "Removedql://foo@hostname/dbname", mock_restore_cmd.call_args[0][0]
        )
...
@patch(
    "dbbackup.db.Removedql.PgDumpBinaryConnector.run_command",
    return_value=(BytesIO(b"foo"), BytesIO()),
)
...
@patch(
    "dbbackup.db.Removedql.PgDumpGisConnector.run_command",
    return_value=(BytesIO(b"foo"), BytesIO()),
)
